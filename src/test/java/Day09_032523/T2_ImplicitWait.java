...
public class T2_ImplicitWait {
    public static void main(String[] args) throws InterruptedException {
        ...
        //do not apply another wait after declaring your implicitwait (thread sleep etc)
        //declare implicit wait just after driver initialization
        //for the driver itself not each webelement
