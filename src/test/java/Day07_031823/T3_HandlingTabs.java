...
public class T3_HandlingTabs {
    public static void main(String[] args) throws InterruptedException {
        ...
        //wait few seconds or else you will not get interactable exception
        Thread.sleep(2000);
        ...
        //getwindows coming from webdriver, forcefully converting set to arraylist this is typecasting
        //typecasting you are going through testlocker, you have taken drivers seat. Convert set to list
        //easier to pick up a specific tab with a list in this case
        ...
        //driver.close closes current window of focus
        //driver.quit quits whole chrome instance/browser itself
